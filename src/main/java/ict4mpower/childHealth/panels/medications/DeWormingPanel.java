	...
	public DeWormingPanel(String id) {
		...
		try {
			meds = Arrays.asList(new Medicine[]{
					new Medicine("0", "De-worming 1", "100 000 IU", df.parse("01/08/2011"), df.parse("01/08/2011"), this),
					new Medicine("6m", "De-worming 2", "100 000 IU", df.parse("01/08/2011"), null, this)
			});
		} catch(Exception e) {
			//
		}
