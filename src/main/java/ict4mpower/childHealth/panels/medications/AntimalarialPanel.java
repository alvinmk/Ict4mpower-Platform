	...
	public AntimalarialPanel(String id) {
		...
		try {
			meds = Arrays.asList(new Medicine[]{
					new Medicine("0", "Antimalarial 1", "100 000 IU", df.parse("01/08/2011"), df.parse("01/08/2011"), this),
					new Medicine("6m", "Antimalarial 2", "100 000 IU", df.parse("01/12/2011"), null, this)
			});
		} catch(Exception e) {
			//
		}
		...
		// Add table items
		add(new ListView<Medicine>("antimalarial", new PropertyModel<List<Medicine>>(data, "antimalarial")) {
