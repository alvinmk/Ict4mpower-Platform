	...
	public AntimalarialPanel(String id) {
		...
		try {
			...
			meds = new ArrayList<Medicine>(Arrays.asList(new Medicine[]{
					new Medicine(p, "Antimalarial 1", Calendar.WEEK_OF_YEAR, 0, df.parse("01/08/2011"), "100 000 IU", "", this),
					new Medicine(p, "Antimalarial 2", Calendar.MONTH, 6, null, "100 000 IU", "", this)
			}));
		} catch(Exception e) {
			//
		}
